...
console.log(`Validated ${records.length} inventory records; Archive ${archiveIds.size}, Condition ${conditionIds.size}, Condition duplicates 0, overlap 0; all publishable derivatives present.`);
